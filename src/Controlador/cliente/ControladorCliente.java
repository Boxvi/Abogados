...
public class ControladorCliente {
    ...
    public void iniciaControl() {
        ...
        //BOTONES PRINCIPALES 
        vista.getBtn_insertarCliente().addActionListener(l -> crearCliente());
        ...
        vista.getBtn_eliminarCliente().addActionListener(l -> eliminarCliente());
    ...
    private void crearCliente() {
        if (!vista.getTxt_cedulaCliente().getText().isEmpty() && !vista.getjCbxEcivil().getSelectedItem().toString().isEmpty()) {
            ModeloCliente modeloCliente = new ModeloCliente();
            if (modeloCliente.exiteRegistro(vista.getTxt_cedulaCliente().getText())) {
    ...
    private void modificarCliente() {
        if (!vista.getTxt_cedulaCliente().getText().isEmpty() && !vista.getjCbxEcivil().getSelectedItem().toString().isEmpty()) {
            ModeloCliente modeloCliente = new ModeloCliente();
            if (modeloCliente.exiteRegistro(vista.getTxt_cedulaCliente().getText())) {
                // modeloCliente.setCod_cliente(modeloCliente.ContarCodigoCliente());
                // modeloCliente.setCedula(vista.getTxt_cedulaCliente().getText());
                modeloCliente.setEstado_civil(vista.getjCbxEcivil().getSelectedItem().toString());
